...
public class EntityCategories 
{
	...
	public static final Set<EntityType> arcano_mobs = EnumSet.of(EntityType.WITCH, EntityType.VEX, EntityType.VINDICATOR, EntityType.ILLUSIONER, EntityType.EVOKER, EntityType.ELDER_GUARDIAN);
	...
	public static final Set<EntityType> glacio_mobs	 = EnumSet.of(EntityType.AXOLOTL,EntityType.PUFFERFISH,EntityType.COD,EntityType.CREAKING,EntityType.DOLPHIN,
			EntityType.GUARDIAN,EntityType.GLOW_SQUID,EntityType.SALMON,EntityType.SNOW_GOLEM,EntityType.SQUID,EntityType.TADPOLE,EntityType.FROG,
	...
	public static final Set<EntityType> heresio_mobs = EnumSet.of(EntityType.CREEPER,EntityType.WITHER,EntityType.PILLAGER,EntityType.RAVAGER, EntityType.ZOMBIE_VILLAGER);
