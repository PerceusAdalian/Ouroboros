...
public class Bases 
{
	public static void load()
	{
		...
		Materia.register(new Materia("Heavy Core",
			...
			Rarity.TWO,
			false,
			"&7&o\"&6&oTemplars used HAMMERs as a badge of honnor,",
		...
		Materia.register(new Materia("Bow Limb",
			...
			Rarity.ONE,
			false,
			"&r&7&oA simple filed bow riser.. nothing to write home about."));
		Materia.register(new Materia("Bow Limb",
			"bow_limb_2",
			MateriaType.BOW,
			MateriaComponent.BASE,
			Rarity.TWO,
			false,
			"&7&o\"&6&oIt was easy picking apart bows for scrap repairs,",
			"&r&6they were vital for both hunting and for pure ranged combat. &o&7&o\""));
		Materia.register(new Materia("Bow Limb",
			"bow_limb_3",
			MateriaType.BOW,
			MateriaComponent.BASE,
			Rarity.THREE,
			false,
			"&7&o\"&b&oThe quality of the bow limb determined the flight distance,",
			"&r&b&oand the power of the shot. We couldn't afford to skip out..&o&7&o\""));
		Materia.register(new Materia("Bow Limb",
			"bow_limb_4",
			MateriaType.BOW,
			MateriaComponent.BASE,
			Rarity.FOUR,
			false,
			"&7&o\"&d&oThe most powerful bows were crafted by vetted carpenters..&7&o\""));
		Materia.register(new Materia("Bow Limb",
			"bow_limb_5",
			MateriaType.BOW,
			MateriaComponent.BASE,
		...
		Materia.register(new Materia("Bow Stock",
			...
			Rarity.ONE,
			false,
			"&r&7&oA simple filed bow stock.. nothing to write home about."));
		Materia.register(new Materia("Bow Stock",
			"bow_stock_2",
			MateriaType.CROSSBOW,
			MateriaComponent.BASE,
			Rarity.TWO,
			false,
			"&7&o\"&6&oThe stock of a crossbow provided the foundation for its power and accuracy,",
			"&r&6&oand the quality determined the stability and accuracy of the shot.&7&o\""));
		Materia.register(new Materia("Bow Stock",
			"bow_stock_3",
			MateriaType.CROSSBOW,
			MateriaComponent.BASE,
			Rarity.THREE,
			false,
			"&7&o\"&b&oCrossbows were a marvel of engineering. Combining both strength",
			"&r&b&oand precision in a single weapon, and used only by the elite.&7&o\""));
		Materia.register(new Materia("Bow Stock",
			"bow_stock_4",
			MateriaType.CROSSBOW,
			MateriaComponent.BASE,
			Rarity.FOUR,
			false,
			"&7&o\"&d&oPacking a serious punch, battle mages often used illegal,",
			"&r&d&oaftermarket parts to enhance their crossbows with elemental magic.&7&o\""));
		Materia.register(new Materia("Bow Stock",
			"bow_stock_5",
			MateriaType.CROSSBOW,
			MateriaComponent.BASE,
