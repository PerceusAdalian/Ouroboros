...
public class FoulPlay extends EchoAbility
{
	...
	public int cast(PlayerInteractEvent e)
	{
		...
		if (!RayCastUtils.getEntity(p, 7, target ->
		{
			...
			double dmg = EchoManager.getCodec(e.getItem()).baseStats().getAttack() * 2.5;
			
			Bukkit.getScheduler().runTaskLater(Ouroboros.instance, ()->
			{
				MobData.damageUnnaturally(p, le, dmg, true, true, ElementType.IMPALE, EchoManager.getCodec(e.getItem()));
