...
public class Smog extends Spell
{
	public Smog()
	{
		super("Smog", "smog", Material.GREEN_DYE, SpellType.OFFENSIVE, SpellementType.INFERNO, CastConditions.RIGHT_CLICK_AIR, Rarity.THREE, 100, 1, false,
				true, "&r&fDeal 20&c♥&f "+PrintUtils.color(ObsColors.INFERNO)+"&lInferno&r&f damage to &6target&f inflicting "+PrintUtils.color(ObsColors.CORROSIVE)+"&oErosion &r&7(30m, 20s)","",
	...
	public int Cast(PlayerInteractEvent e)
	{
		...
		if (!RayCastUtils.getEntity(p, 30, target ->
		{
			...
			ObsParticles.drawAngledArcLine(p.getLocation(), le.getLocation(), 0.6, 9, -delta, 0.2, Particle.LARGE_SMOKE, null);
			ObsParticles.drawCosLine(p.getLocation(), le.getLocation(), 0.5, Particle.COPPER_FIRE_FLAME, null);
			
			Bukkit.getScheduler().runTaskLater(Ouroboros.instance, ()->
			{
				ObsParticles.drawInfernoCastSigil(le);
				MobData.damageUnnaturally(p, le, 20, true, false, ElementType.INFERNO, null);
