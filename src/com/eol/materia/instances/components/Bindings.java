...
public class Bindings 
{
	...
	{
		//-------------------------------STRING-------------------------------//
		Materia.register(new Materia("String Binding &7I",
				"sinew_1",
				MateriaType.STRING,
		...
		Materia.register(new Materia("String Binding &6II",
				"string_2",
				MateriaType.STRING,
				MateriaComponent.BINDING,
				Rarity.TWO,
		...
		Materia.register(new Materia("String Binding &bIII",
				"string_3",
				MateriaType.STRING,
				MateriaComponent.BINDING,
				Rarity.THREE,
		...
		Materia.register(new Materia("String Binding &dIV",
				"string_4",
				MateriaType.STRING,
				MateriaComponent.BINDING,
				Rarity.FOUR,
		...
		Materia.register(new Materia("String Binding &eV",
				"string_5",
				MateriaType.STRING,
				MateriaComponent.BINDING,
				Rarity.FIVE,
