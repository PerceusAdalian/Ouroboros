...
public class GeminiSlash extends EchoAbility
{
	...
	public GeminiSlash() 
	{
		super("Gemini Slash", "gemini_slash_ability", Material.ECHO_SHARD, StatType.MELEE, 10, 5, 30, AbilityType.OFFENSIVE, ElementType.CELESTIO, CastConditions.RIGHT_CLICK_AIR, EchoForm.SWORD,
				"&r&fDeal &l35&r&c♥ "+PrintUtils.color(ObsColors.CELESTIO)+"&lCelestio&r&f damage applying &eExposed &7(5m, 15s)","",
	...
	public int cast(PlayerInteractEvent e) 
	{
		...
		if (!RayCastUtils.getEntity(p, 5, target ->
		{
			...
			MobData.damageUnnaturally(p, target, 35, true, true, ElementType.CELESTIO, EchoManager.getCodec(e.getItem()));
