...
public class Bulwark extends EchoAbility
{
	...
	public Bulwark() 
	{
		super("Bulwark", "bulwark", Material.LEATHER_CHESTPLATE, StatType.MELEE, 15, 3, 35, AbilityType.COMBAT, ElementType.MODULO, CastConditions.RIGHT_CLICK_AIR, EchoForm.HAMMER, 
