...
public class LegionaireGreaves extends AbstractEOLArmor
{

	public LegionaireGreaves()
	{
		super("&r&e&lΣOL&r&f: &oLegionaire Greaves "+PrintUtils.color(ObsColors.HERESIO)+"✦", 
				"legionaire_greaves", 
				EOLRecipe.of(MateriaType.NETHERITE, MateriaType.PELT), 
				new ArmorData(175, 0.135, 55, 0.10, 2500, 2500), 
				EchoForm.LEGGINGS, 
				ElementType.HERESIO,
				buildModifiers(), 
				false, 
    ...
    {
        return List.of(
        		new ActiveArmorModifier(ModifierCondition.ELEMENTAL, ArmorStat.ARMOR_RATING, 65, false, false),
                ...
                new PassiveModifier(ModifierCondition.DURING_NIGHT, PassiveEchoEffect.NIMBLE, .25));
    }
}
