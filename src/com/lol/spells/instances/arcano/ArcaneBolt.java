...
public class ArcaneBolt extends Spell
{
	...
	public ArcaneBolt() 
	{
		super("Arcane Bolt", "arcane_bolt", Material.ECHO_SHARD, SpellType.OFFENSIVE, SpellementType.ARCANO, CastConditions.RIGHT_CLICK_AIR, Rarity.TWO, 25, 1, true, false,
	...
	public int Cast(PlayerInteractEvent e) 
	{
		...
		if (!RayCastUtils.getEntity(p, 25, target->
		{
			...
			MobData.damageUnnaturally(p, target, 4, true, true, ElementType.ARCANO, null);
