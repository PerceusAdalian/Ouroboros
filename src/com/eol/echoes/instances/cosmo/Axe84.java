...
public class Axe84 extends AbstractEOL
{
	...
	private static List<Modifier> buildModifiers()
    {
        return List.of(
            ...
            new PassiveModifier(WeaponModifierCondition.PASSIVE, PassiveEchoEffect.POISONOUS, 0),
            new PassiveModifier(WeaponModifierCondition.PASSIVE, PassiveEchoEffect.COSMO_ARMAMENT, 0));
    }
