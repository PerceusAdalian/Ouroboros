...
public class ScytheAbilitiesPage extends ObsGui
{

	public ScytheAbilitiesPage(Player player)
	{
		super(player, "Scythe Abilities Page", 54, Set.of(10,11,12,13,14,15,16,19,20,21,22,23,24,25,28,29,30,31,32,33,34,38,39,40,41,42,37,43));
	...
	{
		GuiButton.placeAbilityButton(player, new Cleave(), 10, this);
