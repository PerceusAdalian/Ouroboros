...
public class ArmorForgePage extends ObsGui
{

	private ItemStack stack;
	private EchoForm form;
	private boolean forgeConfirmed = false;
	public ArmorForgePage(Player player, ItemStack stack, EchoForm form)
	{
		super(player, "Armor "+Symbols.EOL+"cho Forge", 27, Set.of(10,12,14,16));
		this.stack = stack;
		this.form = form;
	}
	...
	protected void build()
	{
		...
		.setLore("&r&fForge a procedurally generated &b&o"+Symbols.EOL+"cho&r&f from &3Materia&f placed in the slots below.","",
				...
				"&r&fInfluences &oArmor Rating&r&f, &oBlock Rate&r&f, and &bDurability&r&f.","",
				"&dBinding &7(Slot 2)&f: Determines the &b&o"+Symbols.EOL+"cho's &r&f&oCritical&r&f bounds.","",
				...
				"&r&fThe resulting &b&o"+Symbols.EOL+"choes&r&f are among the most &opowerful &r&farmor pieces to have.")
		.place(this, 4, e->
		{
		...
		.place(this, 16, e->
		{
		    ...
		    ItemStack item2 = this.getInventory().getItem(14);
		    ...
		    if (!EchoForm.armor_forms.contains(form)) // Will likely never happen, good to have a check though.
		    	{ rejectForge(p); return; }
		    
		    ItemStack forgedEcho = EchoForge.forgeArmorEcho(Materia.get(stack), base, binding, form);
