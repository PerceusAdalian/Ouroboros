...
public class Bases 
{
	...
	{
		//-------------------------------WOOD-------------------------------//
		Materia.register(new Materia("Wooden Block &7I",
				"wooden_block_1",
				MateriaType.WOOD,
		...
		Materia.register(new Materia("Wooden Block &6II",
				"wooden_block_2",
				MateriaType.WOOD,
				MateriaComponent.BASE,
				Rarity.TWO,
		...
		Materia.register(new Materia("Wooden Block &bIII",
				"wooden_block_3",
				MateriaType.WOOD,
				MateriaComponent.BASE,
				Rarity.THREE,
		...
		Materia.register(new Materia("Wooden Block &dIV",
				"wooden_block_4",
				MateriaType.WOOD,
				MateriaComponent.BASE,
				Rarity.FOUR,
		...
		Materia.register(new Materia("Wooden Block &eV",
				"wooden_block_5",
				MateriaType.WOOD,
				MateriaComponent.BASE,
				Rarity.FIVE,
		...
		//-------------------------------STONE-------------------------------//
		Materia.register(new Materia("Stone Block &7I",
				"stone_block_1",
				MateriaType.STONE,
				MateriaComponent.BASE,
				Rarity.ONE,
		...
		Materia.register(new Materia("Stone Block &6II",
				"stone_block_2",
				MateriaType.STONE,
				MateriaComponent.BASE,
				Rarity.TWO,
		...
		Materia.register(new Materia("Stone Block &bIII",
				"stone_block_3",
				MateriaType.STONE,
				MateriaComponent.BASE,
				Rarity.THREE,
		...
		Materia.register(new Materia("Stone Block &dIV",
				"stone_block_4",
				MateriaType.STONE,
				MateriaComponent.BASE,
				Rarity.FOUR,
		...
		Materia.register(new Materia("Stone Block &dV",
				"stone_block_5",
				MateriaType.STONE,
				MateriaComponent.BASE,
				Rarity.FIVE,
